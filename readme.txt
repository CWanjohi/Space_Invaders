This is a AI agent (5-layer CNN) training to play the classic Atari space invaders game.
The original game is by Lee Robinson (http://www.leejamesrobinson.com/space-invaders.html).
The RL.py file is from a walkover video of Siraj Raval who was doing a PongAI live on Youtube. The original github repo was by Siddarth Malreddy. (Github repo: https://github.com/malreddysid/pong_RL.git)
FILES:
